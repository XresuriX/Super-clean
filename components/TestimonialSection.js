...
const Testimonal = ({name, role, content}) => (
    <div className='bg-white p-6 rounded-lg shadow-lg transform hover:translate-y-1 hover:shadow-xl transition-transform duration-300'>
        ...
        <div className='flex items-center'>
            ...
            <div className='ml-3'>
                ...
                <span className='text-sm text-dark-gray'>{role}</span>
            </div>
        </div>
    </div>
)
...
const TestimonialSection = () => {
  ...
  return (
    <section className='bg-header-image bg-center bg-cover bg-no-repeat py-16 relative overflow-hidden'>
        <div className='container mx-auto text-center relative z-10'>
            <h2 className='text-5xl font-semibold text-secondary mb-6'>Testimonies</h2>
